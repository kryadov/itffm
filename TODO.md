...
- [ ] **Мебель внутри землянки (2/2)** — стол, кровать, картина на стене,
      чашка на столе. По прямой просьбе пользователя 2026-09-09, следующим
      заходом.
- [ ] **Домик рыбака и лодка на берегу** — по прямой просьбе пользователя
      2026-09-09, если в текущей локации есть водоём (`source.water` не
      пуст). Офлайн-демо-лес уже содержит один пруд, так что там будет виден
      сразу; для настоящих мест — зависит от того, размечен ли водоём в OSM.
