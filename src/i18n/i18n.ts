...
export const RU = {
  ...
  questCompleteBike: 'Велосипед оставлен у стены — на тропах теперь можно ехать быстрее.',
  questCompleteDiamond: 'Бриллиант дома — теперь он лежит на столе.',
  questGuideTitle: 'Правила и квесты',
  questGuideIntro:
    'Собирайте грибы, ягоды, орехи и травы: наведите прицел и нажмите E — находка попадёт в корзину и откроет свою страницу в энциклопедии (Tab). В лесу спрятаны пять особых предметов — принесите каждый домой (тем же E, у двери; велосипед — прислоните к любой стене хижины), и все, кроме бриллианта, дадут что-то новое.',
  questItemNameAxe: 'Топор',
  questItemNameLamp: 'Лампа',
  questItemNameRod: 'Удочка',
  needRod: 'нужна удочка',
  needRodToast: 'Рыбу берут только удочкой — а она потеряна где-то в лесу. Найдите её и отнесите домой.',
